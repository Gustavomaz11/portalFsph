...
let titulo = document.querySelectorAll('.blog-title')
let paragrafos = document.querySelectorAll('.blog-content p')
let estrutura = document.querySelectorAll('.estruturaAdm .adms span')
...
const ativarModoEscuro = () => {
  ...
  titulo?.forEach(t => t?.classList.add('fontInDark'))
  paragrafos?.forEach(p => p?.classList.add('fontInDark'))
  estrutura?.forEach(e => e?.classList.add('fontInDark'))
