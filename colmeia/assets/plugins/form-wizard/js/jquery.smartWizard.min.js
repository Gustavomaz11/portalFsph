...
!(function (t, s, e, n) {
  ...
  t.extend(i.prototype, {
    ...
    verifyStep:function  (){
      ...
      if(url.split('#')[1] == 'step-10'){
        if(!$('#img-1').hasClass('usedPreview') || !$('#img-2').hasClass('usedPreview') || !$('#img-3').hasClass('usedPreview')){
          var existPopUp = $('.popup')
          if(existPopUp.length == 0){
            var divPopUp = $(`
              <div>
              <p>Adicione todas as imagens</p>
              </div>
              `).addClass('popup')
              ...
              setTimeout(()=>{
                divPopUp.addClass('showPopup')
              },500)

              setTimeout(()=>{
                divPopUp.removeClass('showPopup')
              },3500)
