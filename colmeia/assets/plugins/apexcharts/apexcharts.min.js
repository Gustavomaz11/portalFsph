            ...
            },
            {
              ...
              value: function (t) {
                ...
                var E = A.config.stroke.dashArray,
                  P = 0;
                P = Array.isArray(E) ? E[a] : A.config.stroke.dashArray;
                var T = this.drawPath({
                  d: e,
                  stroke: l,
                  strokeWidth: h,
            ...
            value: function (t, e, i) {
              ...
              if (!(o < 0 || o > s.globals.gridWidth)) {
                if (null === t.x2) {
                  ...
                  var h = (t.x2 - a) / (n / s.globals.gridWidth);
                  if (h < o) {
                    var c = o;
                    (o = h), (h = c);
                  }
                  var d = this.graphics.drawRect(
                    o + t.offsetX,
                    0 + t.offsetY,
                    h - o,
                    s.globals.gridHeight + t.offsetY,
                ...
                var u = 'top' === t.label.position ? -3 : s.globals.gridHeight,
                  ...
                  if (null !== r) {
                    ...
                    r.setAttribute(
                      ...
                      'top' === t.label.position
                        ? r.setAttribute(
                            'y',
                            parseFloat(r.getAttribute('y')) + o.width,
                          )
                        : r.setAttribute(
                            'y',
                            parseFloat(r.getAttribute('y')) - o.width,
                  ...
                  var h = function (t) {
                      ...
                      if (
                        ...
                        n.config.markers.discrete.map(function (t) {
                          t.seriesIndex === e &&
                            t.dataPointIndex === h &&
                            ((g.pointStrokeColor = t.strokeColor),
                  ...
                  if (s.globals.dataChanged)
                    if (this.dynamicAnim) {
                      ...
                      null !=
                        ...
                        ((E = z.x), (P = z.y), (T = void 0 !== z.r ? z.r : y));
              ...
              for (var o = 0, l = 0; o < t.length; o++, l++) {
                ...
                for (
                  ...
                  (d = P.pathTo),
                    ...
                    z > 0 && m.push(g + k / 2),
                    x.push(p);
                  var T = a.fillPath({ seriesNumber: b, color: E }),
                    ...
                    if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
                      ...
                      S || (S = 'rgba(255, 255, 255, 0)'),
                        this.animateHeatColor(
                          w,
                          d.isColorHex(S) ? S : d.rgb2hex(S),
                          d.isColorHex(b) ? b : d.rgb2hex(b),
                          A,
                        );
                    }
                  }
              ...
              if (
                ...
                t.forEach(function (t, r) {
                  ...
                  for (var f = 0; f < l.linePathsTo.length; f++) {
                    ...
                    o.add(p);
                    var x = s.fillPath({ seriesNumber: r }),
            ...
            value: function (t) {
              ...
              for (
                ...
                n.add(y),
                  ...
                  (t.size = t.size - r - this.margin);
                var w = s.fillPath({ seriesNumber: v, size: t.size }),
                  k = this.startAngle,
                  S = void 0,
                  C = Math.abs(
                ...
                e.globals.dataChanged &&
                  ...
                  Math.abs(M) + Math.abs(S) >= 360 && (M -= 0.01);
                var E = z - k,
                ...
                y.add(T),
                  T.attr({ id: 'apexcharts-radialArc-' + v, index: 0, j: v });
                var F = 0;
                !I.initialAnim ||
                  e.globals.resized ||
                  e.globals.dataChanged ||
            ...
            value: function (t, e, i) {
              ...
              for (
                ...
                M > s.globals.gridHeight && (E = s.globals.gridHeight),
                  (b = w / 2);
                var P = s.globals.padHorizontal + b,
                  T = 1;
                s.globals.isXNumeric &&
                  (P = (s.globals.seriesX[k][0] - s.globals.minX) / g),
                  z.push(P);
                var X = void 0,
                  Y = void 0,
                  I = void 0,
                ...
                } else (X = a.move(_, G)), (Y = a.move(_, E) + a.line(_, G));
                if (
                ...
                for (
                  ...
                  s.globals.isXNumeric
                    ? (P = (s.globals.seriesX[k][$ + 1] - s.globals.minX) / g)
                    : (P += w);
                ...
                if ('area' === o)
                  for (
                    var ot = r.fillPath({ seriesNumber: k }), lt = 0;
                    lt < N.length;
                    lt++
                  ) {
        ...
        s(t, [
          {
            ...
            value: function (t) {
              ...
              if (e.config.yaxis[t].labels.show)
                for (var d = o; d >= 0; d--) {
                  var u = e.globals.yAxisScale[t].result[d];
                  u = c(u, d);
              ...
              if (e.config.xaxis.labels.show)
                for (var d = 0; d <= c - 1; d++) {
                  var u = void 0 === r[d] ? '' : r[d],
                    g = void 0;
                  (g = new D(this.ctx).xLabelFormat(l, u)),
        ...
        s(t, [
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                (t === Number.MIN_VALUE && e === Number.MIN_SAFE_INTEGER)
              )
              ...
              if (
                (void 0 === this.w.config.yaxis[i].max &&
                  void 0 === this.w.config.yaxis[i].min) ||
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.isBarHorizontal || this.setGridXPosForDualYAxis(n, s),
                new N(this.ctx).setYAxisXPosition(s, n);
            },
          },
          {
              ...
              if (a.comboCharts) {
                ...
                switch (s.chart.type) {
                  ...
                  case 'bar':
                    ...
                    break;
                  case 'candlestick':
                    p = new E(this.ctx, e).draw(a.series);
                    break;
                  case 'heatmap':
            ...
            value: function () {
              ...
              if (e.globals.axisCharts) {
                if ('back' === e.config.xaxis.crosshairs.position)
                  new P(this.ctx).drawXCrosshairs();
                if ('back' === e.config.yaxis[0].crosshairs.position)
                  new P(this.ctx).drawYCrosshairs();
                if (
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                if (e.config.grid.yaxis.lines.show)
                  for (
                    var z = 0, M = 0, E = e.globals.gridWidth, P = 0;
                    P < n + 1;
                    P++
                  ) {
                    var T = i.drawLine(
            ...
            value: function () {
              ...
              for (
                ...
                (k.background = s[r]),
                  ...
                  (k.borderWidth = Array.isArray(b) ? b[r] : b),
                  (k.borderColor = Array.isArray(y) ? y[r] : y),
                ...
                if (
                  ...
                  if (
                    ...
                    if (null !== f) {
                      ...
                      void 0 !== r.globals.series[f][e]
                        ? r.config.tooltip.shared &&
                          this.tooltipUtil.isXoverlap(e) &&
                          this.tooltipUtil.isinitialSeriesSameLen()
                          ? this.create(this, f, e, n.ttItems)
                          : this.create(this, f, e, n.ttItems, !1)
                        : this.tooltipUtil.isXoverlap(e) &&
        ...
        s(i, [
              ...
              if (
                ...
                if (s.globals.zoomEnabled) {
                  ...
                  if (r) {
                    ...
                    m &&
                      ((p = m.xaxis ? m.xaxis : p), (f = m.yaxis ? m.yaxe : f));
                  }
                  'x' === i
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              var r = { min: e, max: i };
              s.config.chart.zoom.autoScaleYaxis &&
                (n = new H(me.ctx).autoScaleY(me.ctx, { xaxis: r }));
              this.ctx._updateOptions(
          ...
          plot: function (t) {
            return null == t
              ...
              : this.clear().attr(
                  ...
                  'string' == typeof t
                    ? t
                    : (this._array = new s.PointArray(t)),
                );
          },
          clear: function () {
          ...
          case 'A':
            t = (e = (function (t, e) {
              var i,
                ...
                O = new SVG.Point(Y, I),
                N = [];
              if (0 === M || 0 === E || (F.x === O.x && F.y === O.y))
                return [['C', F.x, F.y, O.x, O.y, O.x, O.y]];
              (i = new SVG.Point((F.x - O.x) / 2, (F.y - O.y) / 2).transform(
                new SVG.Matrix().rotate(P),
              )),
                (s = (i.x * i.x) / (M * M) + (i.y * i.y) / (E * E)) > 1 &&
                  ((s = Math.sqrt(s)), (M *= s), (E *= s));
              (a = new SVG.Matrix()
                .rotate(P)
                .scale(1 / M, 1 / E)
                .rotate(-P)),
              ...
              for (
                m[0][0] = m[0][1].clone(),
                  ...
                  a = new SVG.Matrix().rotate(P).scale(M, E).rotate(-P),
                  k = 0,
                  A = m.length;
                k < A;
                k++
