    ...
    ********************************************************************/
    ...
    AbrirModal = (modalID) => {
        ...
        let modal = new bootstrap.Modal(document.getElementById(modalID),{backdrop : false, keyboard: false });
    ...
    LoadPage = async (page,element_id, execute = null) => {
    ...
    *************************************************************************/
    ...
    async function UploadFiles(Rota, Dados = {}, acCallBack = null) {
